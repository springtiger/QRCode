...
#include "moc/moc_litetabwidget.cpp"
...
void LiteTabWidgetPrivate::init()
{
    ...
    m_tabBar->setObjectName(QLatin1String("_tabwidget_tabbar"));

    m_stack = new QStackedWidget(q);
    m_stack->setObjectName(QLatin1String("_tabwidget_stackedwidget"));
    ...
    q->setObjectName(QLatin1String("_tabwidget"));
...
void LiteTabWidget::setTabEnabled(int index, bool enable) {
	d->m_tabBar->setTabEnabled(index, enable);
}

void LiteTabWidget::setTabVisible(int index, bool visible) {
...
QString LiteTabWidget::tabText(int index) const {
	return d->m_tabBar->tabText(index);
}

void LiteTabWidget::setTabText(int index, const QString &text) {
	d->m_tabBar->setTabText(index, text);
}

#ifndef QT_NO_TOOLTIP
void LiteTabWidget::setTabToolTip(int index, const QString & tip) {
	d->m_tabBar->setTabToolTip(index, tip);
}

QString LiteTabWidget::tabToolTip(int index) const {
	return d->m_tabBar->tabToolTip(index);
}
#endif

#if QT_CONFIG(whatsthis)
void LiteTabWidget::setTabWhatsThis(int index, const QString &text) {
	d->m_tabBar->setTabWhatsThis(index, text);
}

QString LiteTabWidget::tabWhatsThis(int index) const {
	return d->m_tabBar->tabWhatsThis(index);
}
#endif