...
#include "litetabbar_p.h"
#include "moc/moc_litetabbar.cpp"
#include "moc/moc_litetabbar_p.cpp"
...
QString 
LiteTabBar::tabText(int index) const {
	if (QToolButton *tab = d->at(index)) {
		return tab->text();
	}
	return QString();
...
void 
LiteTabBar::setTabText(int index, const QString &text) {
	if (QToolButton *tab = d->at(index)) {
		tab->setText(text);
	}
}
...
void 
LiteTabBar::setTabToolTip(int index, const QString & tip) {
	if (QToolButton *tab = d->at(index)) {
		tab->setToolTip(tip);
	}
}

QString LiteTabBar::tabToolTip(int index) const {
	if (QToolButton *tab = d->at(index)) {
		return tab->toolTip();
	}
	return QString();
...
void 
LiteTabBar::setTabWhatsThis(int index, const QString &text) {
	if (QToolButton *tab = d->at(index)) {
		tab->setWhatsThis(text);
	}
}

QString 
LiteTabBar::tabWhatsThis(int index) const {
	if (QToolButton *tab = d->at(index)) {
